...
const CardList = () => {
    return (
        <ul className="max-w-screen-xl h-full mx-auto py-48 px-10 grid grid-cols-3 items-center justify-center gap-10 ">
            <Card
            ...
            <Card
                ...
                discount={35}
                description="Solo por recomendarnos, puedes accerde a un descuento "
